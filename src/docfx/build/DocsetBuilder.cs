...
internal class DocsetBuilder
{
        ...
        IProgress<string> progressReporter)
    {
        ...
        _templateEngine = TemplateEngine.CreateTemplateEngine(_errors, _config, _packageResolver, _buildOptions.Locale, _buildOptions.Profile, _bookmarkValidator);
        ...
        _tocLoader = new(_buildOptions, _input, _linkResolver, _xrefResolver, _tocParser, _monikerProvider, _dependencyMapBuilder, _contentValidator, _config, _errors, _buildScope, _buildOptions.Profile);
