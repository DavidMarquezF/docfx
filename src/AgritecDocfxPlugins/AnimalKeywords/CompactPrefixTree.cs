...
// Copied from https://github.com/xoofx/markdig/blob/master/src/Markdig/Helpers/CompactPrefixTree.cs
...
namespace AgritecDocfxPlugins.AnimalKeywords
{
    ...
    internal sealed class CompactPrefixTree<TValue> : IReadOnlyDictionary<string, TValue>, IReadOnlyList<KeyValuePair<string, TValue>>
    {
        ...
        private bool TryInsert(in KeyValuePair<string, TValue> pair, InsertionBehavior behavior)
        {
            ...
            if (key.Length == 0) throw new ArgumentOutOfRangeException("key", "string empty");
...
HandleDuplicateKey:;
                ...
                throw new ArgumentException("key", "duplicate key");
